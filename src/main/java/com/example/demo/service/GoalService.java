...
public class GoalService {
	...
	public void setLifeStageGoal() {
        ...
        lifeStageGoals.put(LifeStage.NEW_JOB, List.of("내집마련", "자동차", "결혼", "반려동물", "기타목돈"));
        lifeStageGoals.put(LifeStage.NEW_WED, List.of("내집마련", "자동차", "자녀", "투자비용", "기타목돈"));
        lifeStageGoals.put(LifeStage.NO_CHILD, List.of("반려동물", "내집마련", "은퇴자금", "투자비용", "기타목돈"));
        lifeStageGoals.put(LifeStage.HAVE_CHILD, List.of("내집마련", "자녀", "은퇴자금", "투자비용", "기타목돈"));
